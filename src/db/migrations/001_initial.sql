-- 001_initial.sql
-- BASELINE MIGRATION — frozen at go-live (2026-06). Already applied on production.
-- Do NOT edit this file for new schema changes. Add 002_*.sql, 003_*.sql, … with
-- idempotent SQL safe on the live DB. See docs/DB-MIGRATIONS.md.
